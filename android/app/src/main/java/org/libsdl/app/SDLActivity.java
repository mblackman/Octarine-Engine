...
*/
    ...
    protected String[] getLibraries() {
        // Octarine: SDL3 (and SDL3_image/mixer/ttf) are statically linked into libmain.so by the
        // vcpkg android triplet, so there is no separate libSDL3.so to load — the SDL JNI symbols
        // live in libmain.so. Loading only "main" pulls in the whole engine + SDL.
        return new String[] {
            "main"
        };
    }
