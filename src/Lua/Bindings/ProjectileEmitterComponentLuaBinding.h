...
struct LuaBinding<ProjectileEmitterComponent>
{
    ...
    {
        lua.new_usertype<ProjectileEmitterComponent>(kUsertypeName,
                                                     "velocity", &ProjectileEmitterComponent::velocity,
                                                     "duration", &ProjectileEmitterComponent::duration,
                                                     "frequency", &ProjectileEmitterComponent::frequency,
                                                     "damage", &ProjectileEmitterComponent::damage,
                                                     "countdown_timer", &ProjectileEmitterComponent::countDownTimer,
